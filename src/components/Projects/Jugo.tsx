...
function Jugo() {
    return (
        <>
            ...
            <p>As part of a multi-disciplinary team, I had the opportunity to collaborate on an impactful project for the consultancy firm Jugo. Uniting a team with diverse skills for a common goal; empowering Jugo within the world of Artificial Intelligence.</p>
            ...
            <p>Together with my teammates, we explored the domain of data analysis and machine learning to provide Jugo with insights into the plausibility and possible integration of such predictive AI models within a company.</p>
        </>
    );
}
