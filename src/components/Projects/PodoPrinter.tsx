...
function PodoPrinter() {
    return (
        <>
            ...
            <p>Working in collaboration with the specialized 3D printer company PodoPrinter. My team and I developed a transformative web-based solution aimed at revolutionizing their 3D printing processes. Our mission was to develop a fully web-based alternative to the 3D printing process provided to their customers, allowing for remote printing to the PodoPrinter printers from anywhere in the world, while keeping any data security/privacy concerns in mind.</p>
