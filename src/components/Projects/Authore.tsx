...
function Authore() {
    return (
        <>
            ...
            <p>Engaging with stakeholders within client organizations was crucial to the success of any project I worked on. I actively collaborated with them to gather requirements, provide progress updates, and address any evolving needs or concerns.</p>
