    ...
    return (
        <>
            ...
            <p className="project-intro">
                Procedurally generated web-based multiplayer text adventure game.
            </p>
            ...
            <p>From the enemy encounters to the rooms themselves, the entire game is procedurally generated, ensuring that every player could have a unique experience, and compete against one another in a constantly changing environment. Remember that the game is also not just singleplayer, players will be placed within the same dungeon as other users, allowing real-time interactions with one another, competing against each other or even overcoming challenges that had been <i>attempted</i> by people before.</p>

            <p>The game has a global leaderboards where players can compete to become the strongest survivors in the dungeon, with constantly increasing stakes due to the permanent death of characters, cutting any survivors journey short if not properly taking advantage of all tools available within the dungeon, the game can stay exciting no matter how long you play.</p>
            ...
            <i>
                ...
                <br />
                <span className="note">
                    *The game engine and authentication services are temporarily offline while the cloud-infrastructure is being re-structured for a demo environment.
                </span>
            </i>
        </>
    );
